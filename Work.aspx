...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="form-group col-md-2">
            <input type="button" class="btn btn-success btn-block" onclick="saveAll()" value="<%=lblSave.Text%>" />  
        </div>
        ...
        <div class="frame " style="width: 100%">
            ...
            <ej:Grid ID="Grid1" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <ej:Column Field="other_discount" HeaderText="other_discount"  AllowEditing="false" TextAlign="Right" Format="{0:C}" />
                    <ej:Column Field="rebate" HeaderText="rebate"  />
                    <ej:Column Field="price_after_pro" HeaderText="price_after_pro" TextAlign="Right"  AllowEditing="false" Format="{0:C}"  > 
                    </ej:Column> 
                    <ej:Column Field="vat_add" HeaderText="vat_add"  TextAlign="Right" EditType="NumericEdit"  Format="{0:C}"  > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
                    <ej:Column Field="transport_bkk_nk" HeaderText="transport_bkk_nk" TextAlign="Right" EditType="NumericEdit"  Format="{0:C}"  > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
                    <ej:Column Field="net_price_thai" HeaderText="net_price_thai" AllowEditing="false" Format="{0:C}" />
                    <ej:Column Field="transport_nk_vt" HeaderText="transport_nk_vt" TextAlign="Right" EditType="NumericEdit"  Format="{0:C}"  > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
                    <ej:Column Field="transport_bkk_vt" HeaderText="transport_bkk_vt"  TextAlign="Right" EditType="NumericEdit"  Format="{0:C}"  > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column>                  
                    <ej:Column Field="import_value" HeaderText="import_value"  TextAlign="Right" EditType="NumericEdit"  Format="{0:C}"  > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
                    <ej:Column Field="other_value" HeaderText="other_value"  TextAlign="Right" EditType="NumericEdit"  Format="{0:C}"  > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
                    <ej:Column Field="remark" HeaderText="remark"  />
                    <ej:Column Field="net_cost_price" HeaderText="net_cost_price" AllowEditing="false" TextAlign="Right" Format="{0:C}" />
                     <ej:Column Field="rebate_number"  Visible="false" HeaderText="" AllowEditing="false" TextAlign="Left" Format="{0:C}"/>
                </Columns>
