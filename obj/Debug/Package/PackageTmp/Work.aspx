        ...
        <div class="frame " style="width: 100%">
            ...
            <ej:Grid ID="Grid1" AllowSorting="true"
                ...
                <Columns>
                    ...
                    <ej:Column Field="vat_add" HeaderText="vat_add"  TextAlign="Right" EditType="NumericEdit"    > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
                    <ej:Column Field="transport_bkk_nk" HeaderText="transport_bkk_nk" TextAlign="Right" EditType="NumericEdit"    > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
                    <ej:Column Field="net_price_thai" HeaderText="net_price_thai" AllowEditing="false"  />
                    <ej:Column Field="transport_nk_vt" HeaderText="transport_nk_vt" TextAlign="Right" EditType="NumericEdit"    > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
                    <ej:Column Field="transport_bkk_vt" HeaderText="transport_bkk_vt"  TextAlign="Right" EditType="NumericEdit"    > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column>                  
                    <ej:Column Field="import_value" HeaderText="import_value"  TextAlign="Right" EditType="NumericEdit"    > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
                    <ej:Column Field="other_value" HeaderText="other_value"  TextAlign="Right" EditType="NumericEdit"    > 
                        <NumericEditOptions DecimalPlaces="2"></NumericEditOptions>
                    </ej:Column> 
